...
function(find_ffmpeg_library component header)
  ...
  message(STATUS "TriPham: CMAKE_SYSROOT: ${CMAKE_SYSROOT}")
  set(CMAKE_SYSROOT "")
#  set_property(GLOBAL PROPERTY FIND_LIBRARY_USE_LIB64_PATHS FALSE)
  ...
  find_library(
    ...
    PATHS ${FFMPEG_PATH}
    PATH_SUFFIXES
      lib${flib_suffix}/${MY_LIB_SUFFIX}
      lib/${MY_LIB_SUFFIX}
      libs${_lib_suffix}/${MY_LIB_SUFFIX}
      libs/${MY_LIB_SUFFIX}
      bin${_lib_suffix}/${MY_LIB_SUFFIX}
      bin/${MY_LIB_SUFFIX}
      ../lib${_lib_suffix}/${MY_LIB_SUFFIX}
      ../lib/${MY_LIB_SUFFIX}
      ../libs${_lib_suffix}/${MY_LIB_SUFFIX}
      ../libs/${MY_LIB_SUFFIX}
      ../bin${_lib_suffix}/${MY_LIB_SUFFIX}
